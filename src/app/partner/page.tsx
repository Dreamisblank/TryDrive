  ...
  return (
    <div className="flex-1">
      ...
      <main className="mx-auto max-w-4xl px-6 pt-4 pb-24 text-center">
        ...
        <h1 className="mt-8 text-4xl font-bold tracking-tight text-slate-900 dark:text-neutral-100 sm:text-5xl">
          Partner with us
        </h1>

        <p className="mt-6 leading-relaxed text-slate-600 dark:text-neutral-300">
        ...
        <p className="mt-4 leading-relaxed text-slate-600 dark:text-neutral-300">
          We only earn when you get a booking, which keeps our incentives
          lined up with yours.
        </p>

        <div className="mt-10 rounded-3xl border border-orange-900/5 dark:border-neutral-700/60 bg-white/90 dark:bg-neutral-900/80 p-8 shadow-sm">
