...
const fieldClass =
  "w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-sm text-slate-900 outline-none transition focus:border-orange-400";

const providerButtonClass =
  "flex w-full items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3.5 text-left text-[15px] font-medium text-slate-900 transition hover:border-orange-300 hover:bg-orange-50/60 disabled:cursor-not-allowed disabled:opacity-60";
    ...
    >
      ...
      >
        <button
          ...
          onClick={onClose}
          aria-label="Close"
          className="absolute top-4 right-4 z-10 flex h-8 w-8 items-center justify-center rounded-full text-slate-500 transition hover:bg-white/70 hover:text-slate-900"
        >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle, rgba(234,88,12,0.45) 1.1px, transparent 1.3px), linear-gradient(to bottom, #ffe4c9, #fff7ed)",
        ...
        <div className="px-7 pt-6 pb-7">
          {step === "providers" && (
            <>
              ...
              <h2
                id="auth-modal-title"
                className="mt-1 text-[26px] leading-tight font-bold tracking-tight text-slate-900"
              >
          ...
          {step === "email-sent" && (
            <div className="py-2 text-center">
              ...
              <h2
                id="auth-modal-title"
                className="mt-4 text-[22px] font-bold tracking-tight text-slate-900"
              >
                Check your inbox
              </h2>
              <p className="mt-2 text-sm text-slate-500">
                We sent a sign-in link to{" "}
                <span className="font-medium text-slate-700">{email}</span>. Open
                it on this device to finish signing in.
              </p>
              <button
                type="button"
                onClick={back}
                className="mt-5 text-sm font-medium text-orange-700 hover:text-orange-800"
              >
  ...
  return (
    <div className="mt-5 flex items-center gap-3">
      <button
        type="button"
        onClick={onBack}
        className="rounded-full px-4 py-2.5 text-sm font-medium text-slate-500 transition hover:text-slate-800"
      >
        Back
      </button>
      <button
