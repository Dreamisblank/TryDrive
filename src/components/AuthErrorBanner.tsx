...
export default function AuthErrorBanner() {
  ...
  return (
    <div className="fixed top-4 left-1/2 z-[100] w-[min(92vw,420px)] -translate-x-1/2">
      <div className="flex items-start gap-3 rounded-2xl border border-red-200 bg-white p-4 shadow-xl dark:border-red-900/40 dark:bg-neutral-900">
        ...
        <div className="flex-1">
          ...
          <p className="mt-0.5 text-sm text-slate-600 dark:text-neutral-300">{message}</p>
        </div>
        <button
          type="button"
          onClick={() => setMessage(null)}
          aria-label="Dismiss"
          className="text-slate-400 transition hover:text-slate-700 dark:hover:text-neutral-200"
        >
